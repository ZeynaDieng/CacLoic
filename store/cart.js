...
/*     console.log("ADD_CART_ITEM quantity " + quantityToBeAdd);
 ...
 called `index`. */
  ...
  UPDATE_CART_ITEM_PRICE(state, payload) {
  console.log(payload);
     const cartItem = state.items.find(cartItem => cartItem.item._id === payload.id);
    if (cartItem) {
      console.log(cartItem.item);
      cartItem.item.price = cartItem.item.onSale ? cartItem.item.salePrice : cartItem.item.price;
    }
  },
...
const actions = {
    ...
    singleItemCart.product.price = singleItemCart.product.onSale==true ? singleItemCart.product.salePrice : singleItemCart.product.price
     ...
     // console.log("wesh: " + JSON.stringify(singleItemCart.product.name));
      if (cartItem) {
        ...
        commit("ADD_CART_ITEM", singleItemCart);
      }
    };
 ...
 /*      console.log(
  ...
  removeItem({
   ...
   // console.log(cartItem);
    commit("UPDATE_CART_ITEM_PRICE", payload);
