<template>
  <div class="address-card">
    ...
    <div class="delivery-address" @click="$emit('cardClicked')">
      <AppBadge v-if="isDeliveryAddress" text="Livrer à cette adresse" color=""></AppBadge>
      <AppBadge v-else-if="isDefault" text="Adresse par défaut" color="success"></AppBadge>
...
import BaseAddressCard from '../mixins/BaseAddressCard'
